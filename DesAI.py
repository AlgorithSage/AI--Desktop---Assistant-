...
from ALL_SITES_LISTS import sites
...
if __name__ == '__main__':
    print('Welcome to Desktop AI')
    speak('Welcome Sir')
    speak('I will be activating soon please wait for a while!')
    speak("Desktop Assistant AI is Now Activated sir!")
